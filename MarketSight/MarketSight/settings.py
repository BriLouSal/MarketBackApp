"""
Django settings for MarketSight project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates', 'MarketSightBack/templates', 'MarketSightBack/templates/financial_dashboard',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'MarketSight.wsgi.application'
